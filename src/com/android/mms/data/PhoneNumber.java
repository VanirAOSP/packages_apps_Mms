...
public class PhoneNumber {
    ...
    private PhoneNumber(Context context, long id, String number, int type, String label,
                      String name, boolean isDefault, boolean isFirst, long contactId,
                      ArrayList<Group> groups, boolean isChecked) {
        mContext = context;
    ...
    private static void fillFromCursor(Context context, PhoneNumber phoneNumber,
        ...
        if (Log.isLoggable(LogTag.THREAD_CACHE, Log.VERBOSE)) {
            Log.d(TAG, "fillFromCursor: recipient=" + phoneNumber + ", recipientId="
                + phoneNumber.mId + ", recipientNumber=" + phoneNumber.mNumber);
        }
    }
